...
void demo() {
    ...
    struct circular_ll ll = create_circular_ll();
    ll.traverse(&ll);
    printf("Length: %d\n", ll.length(&ll));
    ...
    struct circular_node* p_node = ll.get_node(&ll, pos);
...
void circular_ll() {
    ...
    struct circular_ll ll = create_circular_ll();
    struct circular_node* p_node = NULL;

    printf("Interactive Circular Linked List\n");
